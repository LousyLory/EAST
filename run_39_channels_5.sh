...
python -u multigpu_train_39_5.py --regC=${reg_constant} --gpu_list=0,1 --input_size=512 --batch_size_per_gpu=16 --checkpoint_path=tmp/east_icdar2015_resnet_v1_39_channel_5/ \
