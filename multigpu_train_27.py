...
training_list = ["D0006-0285025", "D0017-1592006", "D0041-5370006", "D0041-5370026", "D0042-1070001", "D0042-1070002", \
                 ...
                 "D0090-5242001", "D0117-5755018", "D0117-5755024", "D0117-5755033", "D0117-5755025", "D0117-5755035", \
                 "D0117-5755036", "D5005-5028052", "D5005-5028054"]
    ...
    with tf.Session(config=tf.ConfigProto(allow_soft_placement=True)) as sess:
	    ...
	    #list_of_chars = list(string.ascii_lowercase)+[str(x) for x in range(10)]
            while len(data[0]) < 32:
                ...
                if prob > 0.49:
		    #print num_im, len(train_data_indices)
